...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:vmwsree/lektor-admin-web.git; cd lektor-admin-web; fab init
...
[contributing]: http://github.com/vmwsree/lektor-admin-web/tree/master/CONTRIBUTING.md
