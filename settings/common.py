# -*- coding: utf-8 -*-
"""Django settings for lektor-admin project.
...
APPS_DIR = ROOT_DIR.path('lektor_admin')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'lektor_admin.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "lektor_admin.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'lektor_admin.urls'
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/lektor_admin"),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'lektor_admin.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = "lektor_admin.base.views.csrf_failure"
...
def get_release():
    ...
    release = lektor_admin.__version__
    try:
