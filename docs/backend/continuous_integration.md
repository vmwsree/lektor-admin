...
## Setting up lektor-admin with Drone.io Continuous Integration
...
5. Select ` lektor-admin-web ` for your repo
...
psql -c "CREATE DATABASE lektor_admin;" -U postgres
...
1. Click ( "Deployment" )[https://drone.io/github.com/vmwsree/lektor-admin-web/admin/deployments#/]
...
4. Add `https://git.heroku.com:lektor_admin-dev.git` under the Application Git URL
...
8. To have deployment for other branches including testing and production repeat steps 3 --> 7 with:
    - lektor_admin-qa for branch qa
    - lektor_admin-prod for branch prod
